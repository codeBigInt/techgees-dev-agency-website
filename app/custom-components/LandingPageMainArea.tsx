...
const LandingPageMainArea = () => {
  return (
    <div className='w-full flex flex-col relative pt-32 md:pt-0'>
      <div className='w-full flex flex-col items-center'>
        ...
        <p className='px-[10%] text-xs md:text-sm text-gray-700'>Why Experts Say Not Having a Website Hurts Your Business. Watch to learn why!</p>
      </div>
